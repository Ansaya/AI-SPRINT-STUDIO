...
def create_aisprint_designs(application_dir, output_dir):
    ...
    # Save annotations
    with open(os.path.join(output_dir, 'annotations.yaml'), 'w') as f:
        yaml.dump(annotations_dict, f)
    print("* Annotations stored in {}\n".format(os.path.join(output_dir, 'annotations.yaml')))
    ...
    for design_name in design_names:
        ...
        # Save annotations
        with open(os.path.join(design_dir, 'annotations.yaml'), 'w') as f:
            yaml.dump(design_annotations_dict, f)
        print("DONE.")
    print("DONE.\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", help="Path to the output folder for the annotations.yaml file.")
