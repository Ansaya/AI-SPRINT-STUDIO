...
global current_deployment_index, current_base_index, current_services, tested_services
global scar_logs_end_markers
global is_single_service_test, has_lambdas, has_active_lambdas, is_last_run
